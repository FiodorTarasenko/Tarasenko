...
try:
    ...
    with open('/home/b03-301/Documents/data.txt', 'w') as f:
        for i in new_values:
            f.write(str(i) + '\n')
    with open('/home/b03-301/Documents/settings.txt', 'w') as f:
        f.write('Средняя частота дискретизации проведенных измерений: ' + str(1/(experiment_time/number)) + ' Шаг квантования: 0,013' + '\n')
